...
################################################################################
## Form generated from reading UI file 'purple_splash_widget_logo.ui'
##
...
class Ui_PurpleSplashScreen(object):
...
"	border-radius: 150px;\n"
"	background-color: qconicalgradient(cx:0.5, cy:0.5, angle:90, stop:1.0 rgba(170, 0, 255, 0), stop:1.0 rgba(98, 70, 234, 255));\n"
"}")
...
"}")
        ...
        self.label.setPixmap(QPixmap(u":/svg/purple_circle_logo.svg"))
